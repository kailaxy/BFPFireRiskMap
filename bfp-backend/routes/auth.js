...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      console.error('Login DB read failed', {
        route: '/api/auth/login',
        username,
        userId: user.id,
        operation: 'load_station_info',
        message: dbErr.message
      });
      // Optional enrichment only: continue login with station_name = null
    }
    ...
    try {
      ...
      console.error('Login DB write failed', {
        route: '/api/auth/login',
        username,
        userId: user.id,
      ...
      // Optional persistence: continue login success even if refresh token cannot be stored
    }
